...
def create_tournament(request):
    try:
        ...
        if existing_tournaments.exists():
            existing_tournaments.delete()
        data = json.loads(request.body)
        tournament = Tournament.objects.create(creator=request.user,is_active=True,)
        ...
        for participant in participants_data:
            ...
            Participant.objects.create(tournament=tournament,user=user,temp_username=temp_username)
